            ...
            try {
                switch (option){
                    ...
                    case "3" ->{
                        ...
                        System.out.println("Επιτυχής " + withdrawAmount + ", Υπόλοιπο" + accountController.getBalance(iban));
                    ...
                    case "5" -> {
                        List<AccountReadOnlyDTO> readOnlyDTOs = accountController.getAllAaccounts();
                    ...
                    default -> System.out.println("Μή έγκυρη επιλογή. Προσπαθήστε ξανά.");
                }
                ...
                System.out.println("Μή έγκυρη μορφή αριθμού.");
