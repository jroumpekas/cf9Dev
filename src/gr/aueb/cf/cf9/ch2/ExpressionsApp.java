...
public class ExpressionsApp {
    ...
    public static void main(String[] args) {
        ...
        sub = num1 - num2;
        mul = num1 * num2;
        div = num1 / num2; // Η διαίρεση ακεραίων, δεν είναι πάντα ακέραια
        ...
        result2+=1; // Αλλάζει η τιμή του result2 --> 1
        result3++;  // Αλλάζει η τιμή του result3 --> 1, result3 + 1, result+=1
